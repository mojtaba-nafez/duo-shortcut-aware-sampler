...
model_path="/idiap/temp/mnafez/research/duo/our-cscs-trained-checkpoints/duo-17B-clean-loss-term-time-independent-0-02-ablation/last.ckpt"
...
do
    python -u random_perturbation_experiment.py \
        ...
        +corruption_prob=$p \
        +batch_size=64 \
        +save_path="/idiap/temp/mnafez/research/duo/rand_perturb_exp/thresh-disable-ablation-${dataset_name}_p-${p}.json"
