#!/usr/bin/env bash
#SBATCH --job-name=greedy-tail-ablation-coef-0-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
for greedy_step in 0 1 2 3 4 5 6 8 10 12 14 16 18 20; do
    ...
    algo=duo_base \
    eval.checkpoint_path=/idiap/temp/mnafez/research/duo/our-cscs-trained-checkpoints/duo-17B-clean-loss-term-time-independent-0-02-ablation/last.ckpt \
    ...
    eval.generated_samples_path="$PWD/greedy-tail-ablation-result/thresh-disable-ablation-clean-term-greedy-${greedy_step}.json"
done