#!/usr/bin/env bash
#SBATCH --job-name=extra-rand_perturb_exp
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
do
    python -u random_perturbation_experiment.py \
        ...
        +corruption_prob=$p \
        +batch_size=64 \
        +save_path="/idiap/temp/mnafez/research/duo/rand_perturb_exp/${dataset_name}_clean_loss_p-${p}.json"
    ...
    python -u random_perturbation_experiment.py \
        ...
        +corruption_prob=$p \
        +batch_size=64 \
        +save_path="/idiap/temp/mnafez/research/duo/rand_perturb_exp/${dataset_name}_original_p-${p}.json"
